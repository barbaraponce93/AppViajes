...
public final class ItemImageBinding implements ViewBinding {
  ...
  private ItemImageBinding(@NonNull FrameLayout rootView, @NonNull ImageButton btnEliminar,
  ...
  public static ItemImageBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemImageBinding((FrameLayout) rootView, btnEliminar, imageView);
    }
